        ...
        <HOC title="Kontak - Komoditiku">
            ...
            <section className="wrapper__contact">
                ...
                <div className="row">
                    <div className="col-5">
                        <div className="kontak">
                            ...
                            <p>Anda perlu bantuan? Berikut ini alamat yang bisa anda kunjungi serta kontak yang bisa anda hubungi</p>
                        </div>                   
                        <hr></hr>
                        <div className="alamat">
                            <h4>Alamat</h4>
                            <p><i className="bi bi-geo-alt me-2"></i>Jl. Dukuh V Blok Haji Sairi No.21, RT.8/RW.2,</p>
                            <p className="ms-4 lh-1">Dukuh, Kec. Kramat jati, Kota Jakarta Timur, </p>   
                            <p className="ms-4 lh-1">Daerah Khusus Ibukota Jakarta 13550</p>   
                        </div>
                        <div className="telepon">
                            <h4 className="mt-4">Telepon</h4>                   
                            <p><i className="bi bi-telephone me-2"></i>(+62) 811 1001 101</p>
                            <p className="ms-4 lh-1">(+62) 823 456 789</p>                     
                        </div>
                        <div className="bantuan">
                            <h4 className="mt-4">Bantuan</h4>
                            <p><i className="bi bi-envelope me-2"></i>cs@komoditiku.com</p>
                            <p className="ms-4 lh-1">help_komoditiku@support.com</p>                       
                        </div>
                        <div className="ikuti-kami">
                            <h4 className="mt-4 mb-3">Ikuti Kami</h4>
                            <a href=""><i className="bi bi-facebook "></i></a>
                            <a href=""><i className="bi bi-twitter ms-4"></i></a>
                            <a href=""><i className="bi bi-instagram ms-4"></i></a>
                            <a href=""><i className="bi bi-linkedin ms-4"></i></a>  
                        </div>
                    </div>
                    ...
                    <div className="col-7">
                        <div className="wrapper__formkontak">
                            ...
                            <div className="mt-4">
                                <input type="text" className="form-control" id="subject" placeholder="Subjek"></input>
                            </div>
                            <div className="mt-4">
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Apa yang bisa kami bantu?"></textarea>
                            </div>
                ...
                <div className="text-center mt-5">
                    <iframe className="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d16895.57409219322!
                    ...
                    width="1110" height="500" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </section>
            <Footer />
        </HOC>
