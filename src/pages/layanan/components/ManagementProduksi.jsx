    ...
    <>
      ...
      <div className="row">
        <div className="col-4">
          <div className="card-courses">
            <div className="card-title container text-center">
              <img src="./assets/kursusonline/kursus-online-card4.png" />
              <h5 className="container mt-4 mb-3">
                Manajemen Strategi Usaha Perikanan Budidaya
              </h5>
              <p>
                <i className="bi bi-star-fill"></i>
                <i className="bi bi-star-fill"></i>
        ...
        <div className="col-4">
          <div className="card-courses">
            <div className="card-title container text-center">
              <img src="./assets/kursusonline/kursus-online-card5.png" />
              <h5 className="container mt-4 mb-3">
                Cara Pengelolaan Usaha Perikanan
              </h5>
              <p>
                <i className="bi bi-star-fill"></i>
                <i className="bi bi-star-fill"></i>
...
export default ManagementProduksi;
