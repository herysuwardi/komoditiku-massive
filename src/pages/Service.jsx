          ...
          <div className="card-service">
            <div className="row">
              ...
              <div className="col-7">
                <h5>Konsultasi</h5>
                <p>
                  Komoditiku menyediakan sesi konsultasi untuk membantu anda
                  dalam mencapai target bisnis. Pada layanan ini anda dapat
                  melakukan konsultasi permasalahan bisnis anda sesuai dengan
                  kebutuhan anda
                </p>
                <Link to={CONSUL} type="button" className="btn btn-sm">
                  Lihat Selengkapnya
                </Link>
              </div>
            </div>
          ...
          <div className="card-service">
            <div className="row">
              ...
              <div className="col-7">
                ...
                <Link to={EXPLORE} type="button" className="btn btn-sm">
                  Lihat Selengkapnya
                </Link>
              </div>
            </div>
