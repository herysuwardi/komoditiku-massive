  ...
  return (
    <div>
      <section className="wrapper__layanan">
        <Container>
          <div className="text-layanan text-center" data-aos="fade-down">
            <h1>Layanan yang kami Sediakan</h1>
            <p>
              Apa saja layanan yang disediakan oleh Komoditiku? Simak beberapa
              <br></br> layanan yang kami sediakan dibawah ini!
            </p>
          </div>
            ...
            <div className="col-md-3">
              <div className="card__wrapper text-center">
                ...
                <div className="card-body">
                  <h5 className="card-title font-weight-bold text-center mt-4 mb-3">
                    Konsultasi
                  </h5>
                  <p className="text-center container mt-4">
                    Menyediakan sesi konsultasi untuk membantu anda dalam
                    mencapai target bisnis yang ingin dicapai.
                  </p>
                  <Link to={CONSUL} className="btn btn-sm">
                    Lihat Detail
                  </Link>
                </div>
              </div>
            ...
            <div className="col-md-3">
              <div className="card__wrapper text-center">
                ...
                <div className="card-body">
                  ...
                  <p className="text-center container mt-4">
                    Sebagai tempat para pelaku UMKM dalam mempelajari teknis
                    penjualan yang tepat sasaran.
                  </p>
                  <Link to={COURSES} className="btn btn-sm">
                    Lihat Detail
                  </Link>
                </div>
              </div>
